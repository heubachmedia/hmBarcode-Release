## hmBC_Get Barcode List → Barcodes
...
### Description
The command *hmBC_Get Barcode List* returns a collection *Barcodes* with all available Barcodes.
...
$barcodes:=hmBC_Get Barcode List
```
